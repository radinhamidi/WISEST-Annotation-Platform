...
const REACT_APP_RESET_PASSWORD = `${BACKEND_URL}/reset-password`;
...
const ResetPassword = () => {
    ...
    const handleResetPassword = async () => {
        ...
        const response = await fetch(`${REACT_APP_RESET_PASSWORD}`, {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            {passwordChangeSuccess === false && <div className='mt-5'>
                                                        ...
                                                        <div className="row gy-3 overflow-hidden">
                                                            <div className="col-12">
                                                                <div className="form-floating mb-3">
                                                                    ...
                                                                    />
                                                                    <label htmlFor="token" className="form-label">Code</label>
                                                                </div>
                                                            </div>
                                                            <div className="col-12">
                                                                <div className="form-floating mb-3">
                                                            ...
                                                            <div className="col-12">
                                                                <div className="d-grid">
                                                                    <button className="btn btn-dark btn-lg">Change Password</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
            ...
            {passwordChangeSuccess === true && <div className='mt-5'>
                <section className="p-3 p-md-4 p-xl-5">
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-12 col-xxl-11">
                                <div className="card border-light-subtle shadow-lg">
                                    <div className="row g-0">
                                        <div className="col-12 col-md-6" style={{ position: 'relative' }}>
                                            <img className="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src={wisestMainPic} alt="Welcome back you've been missed!" />
                                            <div style={{ position: 'absolute', top: '120px', left: '5px', backgroundColor: 'rgba(0, 0, 0, 0.1)' }} id="banner-overlay">
                                                <h1 className="title">WISEST</h1>
                                                <h2 className="subtitle"><strong>W</strong>h<strong>I</strong>ch <strong>S</strong>ystematic<strong> E</strong>vidence <strong>S</strong>ynthesis is bes<strong>T</strong></h2>
                                                <div className="button-container" id="try-button-small"><a href="/WisestTool"></a></div>
                                            </div>
                                            ...
                                            <div className="col-12 col-lg-11 col-xl-10">
                                                <div className="card-body p-3 p-md-4 p-xl-5">
                                                    <div className="row">
                                                        <div className="col-12">
                                                            <div className="mb-5">
                                                                <h3 style={{ marginTop: '50px' }} className=" text-success text-center">Password Changed Successfully!</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-12">
                                                            <div className="d-grid">
                                                                <button style={{ marginTop: '10px' }} className="btn btn-success btn-lg" onClick={() => navigate("/login")}>Back to Login Page</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
